...
1. Go to your text editior, in my case, I am using [Visual Studio Code](https://code.visualstudio.com/). Login to the Firebase CLI using :
   
   ```
   firebase login
   ```
   
   You will be redirected to your browser to login.

2. After you have successfully login to the Firebase CLI, enter:
   
   ```
   firebase init
   ```
   
   to initialize a your firebase project to this application.
...
Deploy to [Vercel]([Dashboard – Vercel](https://vercel.com/dashboard)[Dashboard – Vercel](https://vercel.com/dashboard)) or [Netlify](https://www.netlify.com/). Remember to setup the environment variables for the app to function correctly.
